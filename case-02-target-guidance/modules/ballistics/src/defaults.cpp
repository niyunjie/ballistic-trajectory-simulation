...
SolverConfig makeDefaultConfig() {
  ...
  config.search.alphaMinDeg = -5.0;
  config.search.alphaMaxDeg = 12.0;
  config.search.betaMinDeg = -360.0;
  config.search.betaMaxDeg = 360.0;
  config.search.controlHeightMinM = 15'000.0;
  config.search.controlHeightMaxM = 35'000.0;
