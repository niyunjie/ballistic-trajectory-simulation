...
struct SearchConfig {
  ...
  double alphaMinDeg = -5.0;
  double alphaMaxDeg = 12.0;
  double betaMinDeg = -360.0;
  double betaMaxDeg = 360.0;
  double controlHeightMinM = 15'000.0;
  double controlHeightMaxM = 35'000.0;
};
