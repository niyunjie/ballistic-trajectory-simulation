...
struct BoundaryPoint {
  ...
  int interceptorSiteIndex = -1;
  double interceptTime = 0.0;
  double interceptLongitudeDeg = 0.0;
  double interceptLatitudeDeg = 0.0;
  double interceptHeightM = 0.0;
  double interceptMarginM = 0.0;
};
...
struct TargetSolution {
  ...
  double flightTime = 0.0;
  double peakAltitude = 0.0;
  InterceptAssessment interceptAssessment;
...
struct FinalResult {
  ...
  std::vector<BoundaryPoint> effectiveAttackBoundary;
  std::vector<BoundaryPoint> interceptedAttackBoundary;
