...
SolverConfig makeDefaultConfig() {
  ...
  config.defense.evaluationSamples = 180;
  config.defense.interceptToleranceM = 25'000.0;
  config.defense.sites.push_back({true, "Terminal Shield", 32.0, 43.0, 0.0, 90.0,
                                  3'500.0, 1'200'000.0, 20'000.0, 800'000.0});
